...
async function sendWelcomeEmailDeliveryPartner(email,userName) {
            ...
            <body>
                <div class="container">
                    <div class="message">
                        ...
                        <p>Please complete your profile and verify your identity by submitting any government-issued document to start receiving orders and earning!</p>
                        <p>Here are the steps:</p>
                        <ol>
                            <li>Login to your FleVo delivery partner account.</li>
                            <li>Go to your profile settings.</li>
                            <li>Complete your profile details, such as username, contact details, etc.</li>
                            <li>Submit your document.</li>
                        </ol>
                        <p>Once you've completed these steps, you'll be ready to start earning through FleVo.</p>
                        ...
                        <p>Thank you for choosing FleVo as your partner in the  delivery business.</p>
                    </div>
                    <div class="footer">
...
module.exports = sendWelcomeEmailDeliveryPartner;
